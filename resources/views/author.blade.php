...
@section ('content')
		...
		<div class="container-fluid autcontent">
			<div class="row">
				<div class="col-md-12 autworker">
					<ul>
						<li><a href="#">Home</a></li>
						
						<li>Profile of shereeifz738</li>
					</ul>
				</div>
			</div>
			<div class="container">
				<div class="row">
					...
					<h2 style="float:right;margin:0">INFO</h2>
						...
						<div class="col-md-7 autworkabout">
							...
							<div class="profile-bottom">
								<div class="profile-overview">
									<div class="owerview" style="height: 140px;"></div>
									<h4>Overview</h4>
						...
						<div class="col-md-4 autworinfo" style="margin-left: 20px;">
							<div class="contact-link">
								<button>Invite me to join </button>
							</div>
